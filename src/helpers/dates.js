...
exports.ascendingSort = key => (a, b) => CompaniDate(a[key]).toDate() - CompaniDate(b[key]).toDate();

exports.descendingSort = key => (a, b) => CompaniDate(b[key]).toDate() - CompaniDate(a[key]).toDate();
