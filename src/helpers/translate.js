module.exports = {
  ...
  'en-EN': {
    ...
    eventCreationNotAllowed: 'Event creation not allow: customer is archived.',
    eventEditionNotAllowed: 'Event edition not allow: customer is archived.',
  ...
  'fr-FR': {
    ...
    archivingNotAllowedBeforeStoppingDate: 'Vous ne pouvez pas archiver un/une bénéficiaire avant sa date d\'arrêt',
    /* Customer notes */
    ...
    eventCreationNotAllowed: 'Impossible de créer l\'évènement, le/la bénéficiaire est archivé(e).',
    eventEditionNotAllowed: 'Impossible d\'éditer l\'évènement, le/la bénéficiaire est archivé(e).',
