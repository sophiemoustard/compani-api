module.exports = {
  ...
  'en-EN': {
    ...
    maxTraineesBiggerThanRegistered: 'Max. number of trainees can\'t be bigger than actual registered number.',
  ...
  'fr-FR': {
    ...
    maxTraineesBiggerThanRegistered: 'Le nombre max. de stagiaires ne peut être inférieur au nombre déjà inscrit.',
