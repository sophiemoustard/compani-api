...
const { checkCategoryNameExists, checkCategoryExists, authorizeCategoryDeletion } = require('./preHandlers/categories');
  ...
  register: async (server) => {
    ...
    server.route({
      ...
      options: {
        ...
        auth: { scope: ['programs:edit'] },
        pre: [{ method: checkCategoryExists }, { method: authorizeCategoryDeletion }],
      },
