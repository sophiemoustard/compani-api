...
const vendorHistoryExportTypes = [
  {
    ...
    expectedRows: [
      ...
      `${courseList[0]._id};"intra";"APA Paris";"Test SAS";"Program 1";"subProgram 1";"group 1";"Gilles FORMATEUR";"Aline CONTACT-COM";"Aline CONTACT-COM";3;1;2;0;"4,00";2;2;;3;3;;;"01/05/2021 10:00:00";"01/05/2021 18:00:00";1;3;3;0;0;"1,00";"1 sur 1";"Oui";"1200,00";"1150,00";"-50,00"`,
      `${courseList[5]._id};"intra";"APA Paris,Test SAS";"Test SAS";"Program 1";"subProgram 1";"group 6";"Gilles FORMATEUR";"Aline CONTACT-COM";"Aline CONTACT-COM";3;1;1;0;"2,00";0;2;;0;0;;;"12/04/2021 12:00:00";"12/04/2021 14:00:00";0;0;3;0;0;"1,00";"2 sur 3";"Non";"880,00";"200,00";"-680,00"`,
      ...
      `${courseList[1]._id};"inter_b2b";"APA Paris";;"Program 2";"subProgram 2";;"Gilles FORMATEUR";"Aline CONTACT-COM";"Aline CONTACT-COM";2;2;2;1;"4,00";1;0;"0,67";1;2;"01/01/2019";"24/10/2018";"01/02/2021 09:00:00";"à planifier";0;2;2;1;2;"0,67";"2 sur 2";"Oui";"800,00";"300,00";"-500,00"`,
      `${courseList[2]._id};"inter_b2b";;;"Program 2";"subProgram 2";"group 3";"Gilles FORMATEUR";"Aline CONTACT-COM";"Aline CONTACT-COM";2;0;0;0;"0,00";0;0;"0,67";0;0;"12/01/2022";"12/01/2022";;;0;0;0;0;0;;"0 sur 2";"Non";;;`,
  ...
  },
  {
    ...
    expectedRows: [
      ...
      `"Facture";"FACT-00001";"08/03/2022";${courseList[0]._id};"Test SAS - Program 1 - group 1";"Test SAS";"APA Paris";"1200,00";"1150,00";;;"-50,00";"1,00"`,
