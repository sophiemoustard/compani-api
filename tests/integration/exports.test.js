...
const clientHistoryExportTypes = [
  ...
  },
  {
    ...
    expectedRows: [
      ...
      `"${auxiliaryList[0]._id}";"Lulu";"Uiui";"11/01/2019 09:30:00";"11/01/2019 10:30:00";"42 Rue de la Procession 75015 Paris";"37 Rue de Ponthieu 75008 Paris";0.23;"Transports en commun / À pied";"0h03";"1h";"Non";"0h03"`,
      `"${auxiliaryList[1]._id}";"Lili";"Lolo";"11/01/2019 11:30:00";"11/01/2019 12:35:00";"42 Rue de la Procession 75015 Paris";"35 Rue du Test 75015 Paris";0.23;"Véhicule personnel";"1h05";"1h05";"Oui";"1h05"`,
    ],
...
const vendorHistoryExportTypes = [
  ...
  },
  {
    ...
    expectedRows: [
      '\ufeff"Id Créneau";"Id Formation";"Étape";"Type";"Date de création";"Date de début";"Date de fin";"Durée";"Adresse"',
      `${courseSlotList[0]._id};${courseList[0]._id};"étape 1";"présentiel";"12/12/2020 11:00:00";"01/05/2021 10:00:00";"01/05/2021 12:00:00";"2,00";"24 Avenue Daumesnil 75012 Paris"`,
      `${courseSlotList[1]._id};${courseList[0]._id};"étape 2";"distanciel";"12/12/2020 11:00:01";"01/05/2021 16:00:00";"01/05/2021 18:00:00";"2,00";"https://meet.google.com"`,
      `${courseSlotList[2]._id};${courseList[1]._id};"étape 1";"présentiel";"12/12/2020 11:00:02";"01/02/2021 09:00:00";"01/02/2021 11:00:00";"2,00";"24 Avenue Daumesnil 75012 Paris"`,
      `${courseSlotList[3]._id};${courseList[1]._id};"étape 3";"eLearning";"12/12/2020 11:00:03";"02/02/2021 09:00:00";"02/02/2021 11:00:00";"2,00";`,
    ],
    query: 'startDate=2021-01-15T10:00:00.000Z&endDate=2022-01-20T10:00:00.000Z',
  },
];
