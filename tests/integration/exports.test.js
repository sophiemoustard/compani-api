...
const vendorHistoryExportTypes = [
  ...
  },
  {
    ...
    expectedRows: [
      '\ufeff"Id formation";"Programme";"Sous-programme";"Prénom Nom intervenant";"Nombre d\'apprenants inscrits";"Nombre de réponses au questionnaire de début";"Moyenne de l’auto-positionnement de début";"Nombre de réponses au questionnaire de fin";"Moyenne de l’auto-positionnement de fin";"Delta entre la moyenne de début et de fin";"Question ayant la plus grande progression";"Progression maximale associée";"Question ayant la plus faible progression";"Progression minimale associée"',
      `${coursesList[0]._id};"Program 1";"subProgram 1";"Gilles FORMATEUR, Simon TRAINERANDCOACH";3;3;"3,22";2;"3,50";"0,28";"Je me sens capable de proposer une animation adaptée a tous les residents";"1,17";"Je me sens capable de cuisiner avec un groupe de residents";"-0,67"`,
      `${coursesList[3]._id};"Program 1";"subProgram 1";"Gilles FORMATEUR";2;2;"1,33";2;"3,83";"2,50";"Je me sens capable de faire la toilette d'un résident seule";"3,00";"Je me sens capable de cuisiner avec un groupe de residents";"2,00"`,
    ],
