  ...
  describe('GET /exports/working_event/history', () => {
    describe('CLIENT_ADMIN', () => {
      ...
      it('should get working events', async () => {
        ...
        expect(rows[3]).toEqual('"Intervention";;"Service 1";"16/01/2019 10:30";"16/01/2019 12:30";"2,00";;"Etoile";"M.";"Lulu";"LALA";"Non";"M.";"BARDET";"Romain";"test";"Non";"Oui";"Facturée & payée";"Initiative de l\'intervenant"');
      });
    });
  ...
  const exportTypes = [
    {
      ...
      expectedRows: [
        ...
        `"Horaire";"Prestataire";"Test SAS";"Service 2";"24,00";"12,00";;"18/01/2019";"${moment().format('DD/MM/YYYY')}";"${moment().format('DD/MM/YYYY')}"`,
      ],
    },
    {
