...
const vendorHistoryExportTypes = [
  {
    ...
    expectedRows: [
      ...
      `${courseList[0]._id};"intra";"APA Paris";"Test SAS";"Program 1";"subProgram 1";"group 1";"Gilles FORMATEUR";"Aline CONTACT-COM";"Aline CONTACT-COM";3;1;2;0;"4,00";2;2;;3;3;;;"01/05/2021 10:00:00";"01/05/2021 18:00:00";1;3;3;0;0;"1,00";"1 sur 1";"Oui";"1200,00";"1100,00";"-100,00"`,
  ...
  },
  {
    ...
    expectedRows: [
      ...
      `"Facture";"FACT-00001";"08/03/2022";${courseList[0]._id};"Test SAS - Program 1 - group 1";"Test SAS";"APA Paris";"1200,00";"1100,00";;;"-100,00";"1,00"`,
