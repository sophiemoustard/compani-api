  ...
  describe('CLIENT_ADMIN', () => {
    ...
    it('should compute draft final pay', async () => {
      const response = await app.inject({
        method: 'GET',
        url: '/finalpay/draft?startDate=2022-12-31T23:00:00.000Z&endDate=2023-01-31T22:59:59.999Z',
      ...
      expect(omit(response.result.data.draftFinalPay[0], ['auxiliary', 'auxiliaryId'])).toEqual({
        ...
        additionalHours: 0,
        bonus: 0,
        endDate: new Date('2023-01-28T22:59:59.000Z'),
        month: '01-2023',
        contractHours: 39,
        holidaysHours: 1.5,
        absencesHours: 1,
        ...
        endReason: 'mutation',
        endNotificationDate: new Date('2023-01-27T23:00:00.000Z'),
        compensation: 0,
      });
    });
  });
