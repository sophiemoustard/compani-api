...
const contract = {
  ...
  endDate: '2024-08-28T21:59:59.000Z',
  endNotificationDate: '2024-08-27T22:00:00.000Z',
  endReason: 'mutation',
  user: auxiliaryId,
...
const eventList = [
  {
    ...
    company: authCompany._id,
    type: 'intervention',
    startDate: '2024-08-04T09:00:00.000Z',
    endDate: '2024-08-04T12:00:00.000Z',
  ...
  },
  {
    ...
    company: authCompany._id,
    type: 'intervention',
    startDate: '2024-08-15T09:00:00.000Z',
    endDate: '2024-08-15T11:00:00.000Z',
    auxiliary: auxiliaryId,
    customer: customerId,
    createdAt: '2024-08-01T09:00:00.000Z',
    sector: new ObjectId(),
  ...
  },
  {
    ...
    endDate: '2024-08-11T16:00:00.000Z',
    auxiliary: auxiliaryId,
    customer: customerId,
  ...
  },
  {
    ...
    company: authCompany._id,
    type: 'internal_hour',
    startDate: '2024-08-02T09:00:00.000Z',
    endDate: '2024-08-02T12:00:00.000Z',
    auxiliary: auxiliaryId,
  ...
  },
  {
    ...
    endDate: '2024-08-01T10:00:00.000Z',
    auxiliary: auxiliaryId,
    internalHour: { _id: new ObjectId(), name: 'Formation' },
  },
  // previous month
  {
    ...
    company: authCompany._id,
    type: 'intervention',
    startDate: '2024-07-14T09:00:00.000Z',
    endDate: '2024-07-14T13:00:00.000Z',
    auxiliary: auxiliaryId,
    customer: customerId,
  ...
  },
  {
    ...
    company: authCompany._id,
    type: 'intervention',
    startDate: '2024-07-01T15:00:00.000Z',
    endDate: '2024-07-01T16:30:00.000Z',
    auxiliary: auxiliaryId,
    customer: customerId,
  ...
  },
  {
    ...
    company: authCompany._id,
    type: 'intervention',
    startDate: '2024-07-13T15:00:00.000Z',
    endDate: '2024-07-13T16:30:00.000Z',
    auxiliary: auxiliaryId,
    customer: customerId,
    createdAt: '2024-07-01T10:00:00.000Z',
    sector: new ObjectId(),
  ...
  },
  {
    ...
    company: authCompany._id,
    type: 'internal_hour',
    startDate: '2024-07-02T09:00:00.000Z',
