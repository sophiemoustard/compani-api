...
const eventList = [
  {
    ...
    sector: new ObjectID(),
    type: INTERNAL_HOUR,
    startDate: '2021-08-17T10:30:18.653Z',
    endDate: '2021-08-17T12:00:18.653Z',
    auxiliary: billUserList[1]._id,
    customer: billCustomerList[0]._id,
  ...
  },
  {
    ...
    sector: new ObjectID(),
    type: INTERVENTION,
    startDate: '2021-08-17T09:30:19.543Z',
    endDate: '2021-08-17T11:30:21.653Z',
    auxiliary: billUserList[1]._id,
    customer: billCustomerList[0]._id,
  ...
  },
  {
    ...
    sector: new ObjectID(),
    type: INTERVENTION,
    startDate: '2021-08-17T14:30:19.543Z',
    endDate: '2021-08-17T16:30:19.543Z',
    auxiliary: billUserList[1]._id,
    customer: billCustomerList[0]._id,
