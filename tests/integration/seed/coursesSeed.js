...
const slots = [
  {
    startDate: CompaniDate('2020-03-01T08:00:00.000Z').toDate(),
    endDate: CompaniDate('2020-03-01T10:00:00.000Z').toDate(),
    course: coursesList[0],
    step: stepList[0]._id,
  },
  {
    startDate: CompaniDate('2020-03-02T13:00:00.000Z').toDate(),
    endDate: CompaniDate('2020-03-02T17:00:00.000Z').toDate(),
    course: coursesList[0],
    step: stepList[0]._id,
  },
  {
    startDate: CompaniDate('2020-03-03T08:00:00.000Z').toDate(),
    endDate: CompaniDate('2020-03-03T10:00:00.000Z').toDate(),
  ...
  {
    startDate: CompaniDate('2020-03-06T08:00:00.000Z').toDate(),
    endDate: CompaniDate('2020-03-06T10:00:00.000Z').toDate(),
    course: coursesList[5],
    step: stepList[0]._id,
  },
  { course: coursesList[7], step: stepList[0]._id },
  {
    startDate: CompaniDate('2020-03-07T08:00:00.000Z').toDate(),
    endDate: CompaniDate('2020-03-07T10:00:00.000Z').toDate(),
    course: coursesList[7],
    step: stepList[0]._id,
  },
  {
    startDate: CompaniDate('2020-03-08T08:00:00.000Z').toDate(),
    endDate: CompaniDate('2020-03-08T10:00:00.000Z').toDate(),
    course: coursesList[8],
    step: stepList[0]._id,
  },
  {
    startDate: CompaniDate('2020-03-09T08:00:00.000Z').toDate(),
    endDate: CompaniDate('2020-03-09T10:00:00.000Z').toDate(),
    course: coursesList[9],
    step: stepList[0]._id,
  },
  {
    startDate: CompaniDate('2020-03-10T08:00:00.000Z').toDate(),
    endDate: CompaniDate('2020-03-10T10:00:00.000Z').toDate(),
