...
describe('PAY ROUTES - GET /pays/export/{type}', () => {
  ...
  describe('CLIENT_ADMIN', () => {
    ...
    it('should export contract for pay', async () => {
      const response = await app.inject({
        method: 'GET',
        url: '/pay/export/contract?startDate=2020-11-01T05:00:00&endDate=2020-11-30T23:00:00',
        headers: { 'x-access-token': authToken },
      });
    ...
    it('should return 400 if invalid type', async () => {
      const response = await app.inject({
        method: 'GET',
        url: '/pay/export/toto?startDate=2020-11-01T05:00:00&endDate=2020-11-30T23:00:00',
        headers: { 'x-access-token': authToken },
      });
    ...
    it('should return 400 if missing endDate', async () => {
      const response = await app.inject({
        method: 'GET',
        url: '/pay/export/contract?startDate=2020-11-01T05:00:00',
        headers: { 'x-access-token': authToken },
      });
