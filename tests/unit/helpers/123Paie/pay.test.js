...
describe('exportPay', () => {
  ...
  it('should export pay hours', async () => {
    ...
    sinon.assert.calledOnceWithExactly(
      ...
      [
        ...
        ['ap_soc', 'serialNumber', '', 'T', '090', 'Heures exo non majo', 99, '', ''],
        ['ap_soc', 'serialNumber', '', 'T', '255', 'Heures exo total', 111, '', ''],
        ['ap_soc', 'serialNumber', '', 'T', '145', 'Heures exo maj dimanche', 0.7, '', ''],
        ['ap_soc', 'serialNumber', '', 'T', '167', 'Heures exo maj ferié', 5, '', ''],
        ['ap_soc', 'serialNumber', '', 'T', '173', 'Heures exo maj 100%', 43, '', ''],
        ['ap_soc', 'serialNumber', '', 'T', '200', 'Heures exo maj soirée', 15, '', ''],
        ['ap_soc', 'serialNumber', '', 'T', '177', 'Heures non exo non majo', 45, '', ''],
        ['ap_soc', 'serialNumber', '', 'T', '115', 'Heures supplémentaires', 2, '', ''],
        ['ap_soc', 'serialNumber', '', 'T', '100', 'Heures complémentaires', 4, '', ''],
        ['ap_soc', 'serialNumber', '', 'T', '430', 'Carte navigo', '', 19, ''],
        ['ap_soc', 'serialNumber', '', 'T', '512', 'Frais téléphoniques', '', 35.7, ''],
        ['ap_soc', 'serialNumber', '', 'T', '489', 'Frais kilométriques', '', 0, ''],
      ]
    );
